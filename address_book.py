...
root.config(bg = '#042b7a')
root.title('My-AddressBook')
root.resizable(0,0)
contactlist = [
    ['abhishek',  '9878765767'],
    ['ankit',  '6767676766'],
    ['Mohan kumar  ',   '7635844632'],
    ['Narendra Modi','9897675645'],
    ['mohit khanna',   '09988776543'],
    ['papu' , '8987565403'],
    ]
...
select = Listbox(frame, yscrollcommand=scroll.set, height=18)
...
Button(root,text=" ADD", font='arial 12 bold',bg='#84ADF9', command = AddContact).place(x= 50, y=110)
Button(root,text="EDIT", font='arial 12 bold',bg='#84ADF9',command = EDIT).place(x= 50, y=260)
Button(root,text="DELETE", font='arial 12 bold',bg='#84ADF9',command = DELETE).place(x= 50, y=210)
Button(root,text="VIEW", font='arial 12 bold',bg='#84ADF9', command = VIEW).place(x= 50, y=160)
